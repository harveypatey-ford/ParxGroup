...
import { ArrowLeft, ChevronRight, Save, Upload, File, Check, X, Info, Shield, FileCheck, Building, Users2, Clock, PoundSterling, Landmark, Briefcase, MapPin } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import AnimatedSection from '../components/AnimatedSection';
import StatusDisclosure from '../components/StatusDisclosure';

function CreatePIPApplication() {
  ...
  const [uploadedFiles, setUploadedFiles] = useState<{[key: string]: File | null}>({
    ...
    exemptRentsBreakdown: null,
    structureChart: null,
    businessPlan: null,
    sampleLease: null,
    demandReport: null,
    planningPermissions: null,
    otherDocuments: null
  });
  ...
  const formSections = [
    {
      ...
      fields: [
        ...
        { name: "managementType", label: "Will the portfolio be managed by a Registered Provider 'RP' Or Community Interest Company 'CIC'", type: "select", options: ['RP', 'CIC'], required: true },
        { name: "rpName", label: "Registered Provider 'RP' Name", type: "text", conditionalOn: { field: "managementType", value: "RP" } },
        { name: "cicName", label: "Community Interest Company 'CIC' Name", type: "text", conditionalOn: { field: "managementType", value: "CIC" } },
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "unitCount", label: "Number of Units", type: "number", required: true },
        { name: "currentUse", label: "Current use", type: "text", required: true },
        { name: "intendedUse", label: "Intended use", type: "text", required: true },
        { name: "exemptAccommodation", label: "Are the properties Exempt Accommodation?", type: "radio", options: ["yes", "no"], required: true },
    ...
    },
    {
      ...
      fields: [
        { name: "exemptRents", label: "Does the portfolio qualify for Exempt Rents?", type: "radio", options: ["yes", "no"], required: true },
        ...
        { name: "localAuthorityIncome", label: "Income received from Local Authority and/or NHS?", type: "text", required: true },
        ...
        { name: "rpCicIncomePercentage", label: "Portion of rental income expected by the RP/CIC (%)", type: "text", required: true },
    ...
    },
    {
      ...
      fields: [
        { name: "rentReservePeriod", label: "What period of rent will be reserved to cover short term voids? (6 months minimum)", type: "select", options: ["6 months", "12 months", "Other"], required: true }
      ]
    },
    {
      ...
      fields: [
        { name: "rpCicName", label: "Name of the Registered Provider 'RP'/ Community Interest Company 'CIC'", type: "text", required: true },
        { name: "rpCicWebsite", label: "Website", type: "text", required: true },
        ...
        { name: "managementPersonnel", label: "Summary of the RP/CIC management personnel", type: "textarea", required: true },
    ...
    },
    {
      ...
      description: "Information about local authority involvement",
      icon: <MapPin className="h-6 w-6" />,
      fields: [
        { name: "localAuthorities", label: "Name of local authority(s)", type: "text", required: true },
        { name: "waitingList", label: "Is there a waiting list of residents?", type: "radio", options: ["yes", "no"], required: true },
        { name: "waitingListCount", label: "How many people on the waiting list?", type: "number", required: true, conditionalOn: { field: "waitingList", value: "yes" } }
      ]
    },
    {
      id: 'portfolioOwner',
    ...
    },
    {
      ...
      fileUploads: [
        ...
        { name: "financialsBreakdown", label: "Financial Breakdown", required: true },
        { name: "exemptRentsBreakdown", label: "Exempt Rents Breakdown", required: false },
        ...
        { name: "demandReport", label: "Demand Report", required: false },
        { name: "planningPermissions", label: "Planning Permissions", required: false }
      ]
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center">
            ...
            <h1 className="text-2xl font-bold text-neutral-900">
              Portfolio Investment Protection Application
            </h1>
          </div>
        </div>
      </header>
              ...
              <div className="bg-neutral-50 p-6 rounded-lg mb-6">
                <div className="flex items-start mb-4">
                  ...
                  <p className="text-neutral-600 text-sm">
                    Please upload the following documents to support your application. These documents will help us assess your risk profile and provide an accurate quote.
                  </p>
                </div>
...
export default CreatePIPApplication;